...
class Model(BaseModel):
    ...
    def __init__(self, args, next_element):
        ...
        self.cand_entities, self.cand_entities_scores, self.cand_entities_la!!!! init embeddings !!!!bels,\
    ...
    def add_embeddings_op(self):
        ...
        with tf.variable_scope("chars"):
            if self.args.use_chars:
                ...
                char_embeddings = tf.reshape(char_embeddings, shape=[s[0] * s[1], s[-2s[0] * s[1], s[-2], self.args.dim_char])
